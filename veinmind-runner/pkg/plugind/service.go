...
// StartPluginsService Start all plugins Services
...
// StopPluginsService stop all plugins Services
...
// StatusPluginsServices get a plugin all services status
...
// StatusAllPluginsService get all plugins services status
